...
namespace Stok_Takip_Programı
{
    public partial class frmÜrünEkle : Form
    {
        ...
        private void kategorigetir() //kategori getir metodunu çağırdım
        {
            baglanti.Open();
        ...
        private void btnYeniEkle_Click(object sender, EventArgs e)//ürün ekleme işlemleri
        {
            barkodkontrol();
            if (durum==true)
            {
        ...
        private void BarkodNotxt_TextChanged(object sender, EventArgs e)
        {
            ...
            while (read.Read())
            {
                Kategoritxt.Text = read["kategori"].ToString(); //burada tek tek kategoriyi ve digerlerini cekiyoruz
        ...
        {
            baglanti.Open(); //baglantı actık ve bir altta olan miktarın üzerine ekliyoruz
